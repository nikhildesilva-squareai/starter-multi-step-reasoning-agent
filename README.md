...
![Intermediate](https://img.shields.io/badge/difficulty-intermediate-F59E0B) ![LLM Agent Architect](https://img.shields.io/badge/course-LLM%20Agent%20Architect-0056CE) ![14 hours](https://img.shields.io/badge/estimated-14h-lightgrey)

> **Square 1 AI** starter template — LLM Agent Architect

## Overview

In this intermediate-level project, you'll build a **Multi-Step Reasoning Agent** using Python, Anthropic SDK, ReAct. Implement the ReAct pattern for complex multi-step reasoning tasks. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-multi-step-reasoning-agent.git
cd starter-multi-step-reasoning-agent
